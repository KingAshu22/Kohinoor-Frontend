...
const TermsOfServicePage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <Head>
        <title>Terms of Service - Kohinoor Flags & Batches</title>
        <meta
          name="description"
          content="Terms of Service for Kohinoor Flags & Batches e-commerce website."
        />
      </Head>
      <h1 className="text-3xl font-semibold mb-4">Terms of Service</h1>
      <h2 className="text-xl font-semibold mb-2">OVERVIEW</h2>
      <p className="mb-6">
        This website is operated by Kohinoor Flags & Batches. Throughout the
        site, the terms “we”, “us” and “our” refer to Kohinoor Flags & Batches.
        Kohinoor Flags & Batches offers this website, including all information,
      ...
      <p className="mb-6">
        ...
        hyperlink from any part or portion of our website. These Terms of
      ...
      <p className="mb-6">
        ...
        corrected. Products, including those on discount, are subject to
        availability.
      </p>
      <h2 className="text-xl font-semibold mb-2">
      ...
      <p className="mb-6">
        ...
        shall InWeave, our directors, officers, employees, affiliates, agents,
      ...
      <p className="mb-6">
        You agree to indemnify, defend and hold harmless InWeave and our parent,
      ...
      <p className="mb-6">
        ...
        laws of Kohinoor Flags & Batches, Orchid Corporate Park, Royal Palms,
        Mayur Nagar, Aarey Milk Colony, Goregaon East, Mumbai 400 065
      </p>
      <h2 className="text-xl font-semibold mb-2">
      ...
      <p className="text-sm text-gray-600">
        ...
        <a href="mailto:kohinoorflags@gmail.com" className="text-blue-500">
          kohinoorflags@gmail.com
        </a>{" "}
